...
class GridChooseCategoryQuestionTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final isSelected = ref.watch(isSelectedClicked(index));
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: ref.read(isSelectedClicked(index).notifier).state
                        ? Border.all(color: AppColorScheme.yellowborder, width: 2.w)
                        : Border.all(color: AppColorScheme.greenborder, width: 2.w),
                    gradient: ref.read(isSelectedClicked(index).notifier).state
                        ? LinearGradient(
                      colors: [
