...
class SecondGridDifficultyLevelScreen extends StatefulWidget {
  const SecondGridDifficultyLevelScreen({super.key});

  @override
  State<SecondGridDifficultyLevelScreen> createState() => _SecondGridDifficultyLevelScreenState();
}

class _SecondGridDifficultyLevelScreenState extends State<SecondGridDifficultyLevelScreen> {
  @override
  void initState() {
    super.initState();
