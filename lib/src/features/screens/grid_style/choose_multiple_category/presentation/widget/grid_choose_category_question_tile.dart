...
class GridChooseCategoryQuestionTile extends ConsumerWidget {
  final int index;
  final void Function()? onTap;
  const GridChooseCategoryQuestionTile({super.key, required this.index, required this.onTap});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final isSelected = ref.watch(isCategorySelectedClicked(index));
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: ref.read(isCategorySelectedClicked(index).notifier).state
                        ? Border.all(color: AppColorScheme.yellowborder, width: 2.w)
                        : Border.all(color: AppColorScheme.greenborder, width: 2.w),
                    gradient: ref.read(isCategorySelectedClicked(index).notifier).state
                        ? LinearGradient(
                      colors: [
